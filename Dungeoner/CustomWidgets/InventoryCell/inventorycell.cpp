...
void InventoryCell::styleRemoved()
{
    if(acceptedSlot != Item::INVENTORY){
        QVector<Item::Slots> itemSlots = getItem()->getOccupiedCellSlots();
        QMutableVectorIterator<Item::Slots> iterator(itemSlots);
        while(iterator.hasNext()){
            Item::Slots searchedSlot = iterator.next();
            if(searchedSlot == Item::ONE_OF_THE_GLOVE){
                if(acceptedSlot == Item::L_GLOVE){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_GLOVE){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_SHOULDER){
                if(acceptedSlot == Item::L_SHOULDER){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_SHOULDER){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_BRACE){
                if(acceptedSlot == Item::L_BRACE){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_BRACE){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_GAUNTLET){
                if(acceptedSlot == Item::L_GAUNTLET){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_GAUNTLET){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_GREAVE){
                if(acceptedSlot == Item::L_GREAVE){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_GREAVE){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_BOOT){
                if(acceptedSlot == Item::L_BOOT){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_BOOT){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_HAND){
                if(acceptedSlot == Item::L_HAND){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_HAND){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == Item::ONE_OF_THE_DECORATION){
                if(acceptedSlot == Item::L_DECORATION){
                    iterator.remove();
                    break;
                }else if(acceptedSlot == Item::R_DECORATION){
                    iterator.remove();
                    break;
                }
            }else if(searchedSlot == acceptedSlot){
                iterator.remove();
                break;
            }
        }

        emit checkLockedCells(itemSlots);
