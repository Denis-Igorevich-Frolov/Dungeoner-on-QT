...
static const qt_meta_stringdata_InventoryCell_t qt_meta_stringdata_InventoryCell = {
    {
        ...
        QT_MOC_LITERAL(14, 18),  // "dragSourceObtained"
        QT_MOC_LITERAL(33, 0),  // ""
        QT_MOC_LITERAL(34, 14),  // "InventoryCell*"
        QT_MOC_LITERAL(49, 10),  // "sourceCell"
        QT_MOC_LITERAL(60, 18),  // "dropTargetObtained"
        QT_MOC_LITERAL(79, 10)   // "targetCell"
    },
    "InventoryCell",
    "dragSourceObtained",
    "",
...
void InventoryCell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &InventoryCell::dragSourceObtained; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (InventoryCell::*)(InventoryCell * );
            if (_t _q_method = &InventoryCell::dropTargetObtained; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<InventoryCell, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<InventoryCell *, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<InventoryCell *, std::false_type>
...
// SIGNAL 0
void InventoryCell::dragSourceObtained(InventoryCell * _t1)
{
...
// SIGNAL 1
void InventoryCell::dropTargetObtained(InventoryCell * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
