...
"}"));
        ...
        scrollArea = new QScrollArea(CharacterWindow);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setGeometry(QRect(100, 210, 616, 394));
...
"border: none;"));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, -380, 616, 774));
        ...
        PhysicalDamage = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        ResistPhysicalDamage = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        StrengtheningPhysicalEffects = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        Stealth = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        ResistMagicDamage = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        ResistPhysicalEffects = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        StrengtheningMagicalEffects = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        Attentiveness = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        Initiative = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        MeleeAccuracy = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        RangedAccuracy = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        LoadCapacity = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        ResistMagicEffects = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        MagicDamage = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        MagicAccuracy = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        Evasion = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        MagicCastChance = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        ChanceToUseCombat = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        MagicTechniqueCastChance = new SecondarySkill(scrollAreaWidgetContents_2);
        ...
        TravelRange = new SecondarySkill(scrollAreaWidgetContents_2);
