    ...
    ui(new Ui::CharacterWindow)
{
    ...
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 10, false, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 11, false, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 3, false, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 7, true, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 8, true, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 43, false, "F"));
    person.addBonusToStat(new Bonus(Bonus::MAGIC_DAMAGE, 22, true, "F"));
