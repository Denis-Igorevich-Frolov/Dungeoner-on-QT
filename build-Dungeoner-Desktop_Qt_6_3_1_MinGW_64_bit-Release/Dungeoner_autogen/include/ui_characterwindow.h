...
"border: none;"));
    ...
    void retranslateUi(QWidget *CharacterWindow)
    {
        ...
        ResistMagicDamage->setProperty("Formula", QVariant(QCoreApplication::translate("CharacterWindow", "1.5\342\200\242\320\222\320\276\320\273\321\217 + \320\234\320\260\320\263 + 0.5\342\200\242\320\242\320\265\320\273", nullptr)));
        ...
        ResistPhysicalDamage->setProperty("Formula", QVariant(QString()));
        ...
        StrengtheningPhysicalEffects->setProperty("Formula", QVariant(QString()));
        ...
        ResistPhysicalEffects->setProperty("Formula", QVariant(QString()));
        ...
        StrengtheningMagicalEffects->setProperty("Formula", QVariant(QString()));
        ...
        ResistMagicEffects->setProperty("Formula", QVariant(QString()));
        ...
        RangedAccuracy->setProperty("Formula", QVariant(QCoreApplication::translate("CharacterWindow", "0.1\342\200\242\320\233\320\276\320\262\320\272 + 15", nullptr)));
        ...
        Stealth->setProperty("Formula", QVariant(QString()));
