...
#include <memory>
#include "../../../Dungeoner/CustomWidgets/InventoryItem/inventoryitem.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_InventoryItem_t::offsetsAndSizes) + ofs), len 
...
void InventoryItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
const QMetaObject InventoryItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_InventoryItem.offsetsAndSizes,
...
const QMetaObject *InventoryItem::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *InventoryItem::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_InventoryItem.stringdata0))
        return static_cast<void*>(this);
    return QWidget::qt_metacast(_clname);
}

int InventoryItem::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
