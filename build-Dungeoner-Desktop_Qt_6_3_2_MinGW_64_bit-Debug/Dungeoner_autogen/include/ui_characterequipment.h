...
public:
    ...
    InventoryCell *LefttBrace;
    InventoryCell *RightGauntlet;
    InventoryCell *LeftGauntlet;
    InventoryCell *RightGreaves;
    InventoryCell *LeftGreaves;
    ...
    void setupUi(QWidget *CharacterEquipment)
    {
        ...
        LefttBrace = new InventoryCell(Armor);
        LefttBrace->setObjectName(QString::fromUtf8("LefttBrace"));
        LefttBrace->setGeometry(QRect(216, 157, 68, 68));
        LefttBrace->setMouseTracking(true);
        LefttBrace->setAcceptDrops(true);
        ...
        RightGreaves = new InventoryCell(Armor);
        RightGreaves->setObjectName(QString::fromUtf8("RightGreaves"));
        RightGreaves->setGeometry(QRect(113, 295, 68, 68));
        RightGreaves->setMouseTracking(true);
        RightGreaves->setAcceptDrops(true);
        LeftGreaves = new InventoryCell(Armor);
        LeftGreaves->setObjectName(QString::fromUtf8("LeftGreaves"));
        LeftGreaves->setGeometry(QRect(181, 295, 68, 68));
        LeftGreaves->setMouseTracking(true);
        LeftGreaves->setAcceptDrops(true);
