...
void *Dungeoner::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_Dungeoner.stringdata0))
        return static_cast<void*>(this);
    return QMainWindow::qt_metacast(_clname);
}

int Dungeoner::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
