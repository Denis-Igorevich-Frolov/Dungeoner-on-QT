...
public:
    ...
    void setupUi(QWidget *ProgressBar_2)
    {
        ...
        ProgressBar_2->resize(262, 42);
        ProgressBar = new QFrame(ProgressBar_2);
        ProgressBar->setObjectName(QString::fromUtf8("ProgressBar"));
        ProgressBar->setGeometry(QRect(0, 0, 262, 42));
        ProgressBar->setFrameShape(QFrame::StyledPanel);
        ProgressBar->setFrameShadow(QFrame::Raised);
        BordersWrapper = new QFrame(ProgressBar);
        ...
        ChunkWrapper = new QFrame(ProgressBar);
        ...
        TipsWrapper = new QFrame(ProgressBar);
        ...
        ShadowWrapper = new QFrame(ProgressBar);
        ...
        LabelWithTooltipWrapper = new QFrame(ProgressBar);
