...
QString WB2_Stylemaster::BottomLeftCornerStyle()
{
    ...
    "QLabel{"
    "   background: none;"
    "   background-image: url(:/Text-Block-4/Textures PNG/Angle-1-B-L.png);"
    "}";
}
...
QString WB2_Stylemaster::TopLeftCornerStyle()
{
    ...
    "QLabel{"
    "   background: none;"
    "   background-image: url(:/Text-Block-4/Textures PNG/Angle-1-T-L.png);"
    "}";
}
...
QString WB2_Stylemaster::BottomRightCornerStyle()
{
    ...
    "QLabel{"
    "   background: none;"
    "   background-image: url(:/Text-Block-4/Textures PNG/Angle-1-B-R.png);"
    "}";
}
...
QString WB2_Stylemaster::TopRightCornerStyle()
{
    ...
    "QLabel{"
    "   background: none;"
    "   background-image: url(:/Text-Block-4/Textures PNG/Angle-1-T-R.png);"
    "}";
}
